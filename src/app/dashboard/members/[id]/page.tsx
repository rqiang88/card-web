...
export default function MemberDetailPage() {
  ...
  // 处理查看充值详情
  const handleViewRechargeDetail = (rechargeId: string) => {
    router.push(`/dashboard/recharges/${rechargeId}`)
  }
  ...
  // 计算统计数据
  const totalRechargeAmount = (recharges || []).reduce((sum, r) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {member.birthday && (
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-slate-700">
                    {dayjs(member.birthday).format('YYYY-MM-DD')}
                  </p>
                </div>
              </div>
            )}
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="font-medium text-slate-700">
                  {member.registerAt
                    ? dayjs(member.registerAt).format('YYYY-MM-DD')
                    : '未知'}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-2xl font-bold text-emerald-600">
                  ¥{Math.floor(totalRechargeAmount).toLocaleString()}
                </p>
              </div>
            </div>
          </CardContent>
